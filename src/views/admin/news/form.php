    ...
    <div class="flex flex-col bg-white shadow-xl">
      ...
      <form method="POST"
        ...
        <input type="text"
          name="title"
          required
          class="mt-1 w-full border border-gray-200 rounded-md p-2 focus:border-blue-900 outline-none">

        <label class="block mt-4 text-gray-700 font-medium">Entradilla</label>
        <textarea name="lead"
          required
          class="mt-1 w-full border border-gray-200 rounded-md p-2 h-15 resize-none focus:border-blue-900 outline-none"></textarea>

        <label class="block mt-4 text-gray-700 font-medium">Cuerpo</label>
        <textarea name="body"
          required
          class="mt-1 w-full border border-gray-200 rounded-md p-2 h-25 resize-none focus:border-blue-900 outline-none"></textarea>

        <label class="block mt-4 text-gray-700 font-medium">Imagen (opcional)</label>
        <input type="file"
          name="image"
          accept="image/*"
          class="mt-1 w-full border border-gray-200 rounded-md p-2 bg-white cursor-pointer focus:ring-blue-900 focus:border-blue-900 outline-none">
